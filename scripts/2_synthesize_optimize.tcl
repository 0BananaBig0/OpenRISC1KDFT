...
write_db  ${output_dir}/odb/OpenRISC1k_chip.syn.odb
...
#=======================================================#
optimize -virtual
write_db  ${output_dir}/odb/OpenRISC1k_chip.virtual_opt.odb
report_timing
report_path_groups
...
######################################################################
redirect -file ${output_dir}/OpenRISC1k_chip.create_chip.log { create_chip   -bottom_clearance 30 -left_clearance 30 -right_clearance 30 -top_clearance 30 -utilization 60 }
set die [ exec cat ${output_dir}/OpenRISC1k_chip.create_chip.log | grep "create new die" | cut -c46-56 ]
...
optimize -place
write_db  ${output_dir}/odb/OpenRISC1k_chip.placed_opt.odb
report_timing
report_path_groups
